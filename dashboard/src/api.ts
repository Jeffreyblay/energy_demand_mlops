...
import type { RegionsResponse, ForecastResponse, HistoryResponse, CoverageResponse, NearbyResponse } from "./types";
...
export const fetchNearby = (region: string, radiusKm = 800) =>
  getJSON<NearbyResponse>(`/regions/nearby?region=${encodeURIComponent(region)}&radius_km=${radiusKm}`);
